...
public class homepage {
    ...
    public void Valid_Login_TC(WebDriver driver) throws IOException {
        ...
        String username =ReadData("Sheet1", 1, "username");
        ...
        try {
            ...
            try {
                ...
                LoggerHandler.loginfo("This is a info message.");
                LoggerHandler.logSevere("This is a SEVERE message.");
                LoggerHandler.logWarning("This is a WARNING message.");
                LoggerHandler.logConfig("This is a CONFIG message.");
                LoggerHandler.logdebug("Thus is Debug message");
                LoggerHandler.logFine("This is a FINE message.");
                LoggerHandler.logFiner("This is a FINER message.");
                LoggerHandler.logFinest("This is a FINEST message."); 
                LoggerHandler.logerror("This is error meessage");
